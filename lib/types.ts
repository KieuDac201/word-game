// ──────────────────────────────────────────────────────────────
// Type definitions for the Falling-Sentence Typing Practice Game
// ──────────────────────────────────────────────────────────────
...
export interface DifficultyConfig {
  label: string;
  description: string;
  wordCountRange: [number, number]; // [min, max] words per sentence
  maxSimultaneous: number;
  spawnIntervalMs: number; // base interval between spawns
  baseFallSpeedPPS: number; // base pixels per second
}
